...
import com.theflexproject.thunder.utils.ColapsingTitle;
...
public class SeriesFragment extends BaseFragment {
    ...
    // new ScaleCenterItemLayoutManager(getContext(), RecyclerView.HORIZONTAL,
    // false));
    // trendingView.setHasFixedSize(true);
    // trendingAdapter = new DrakorBannerAdapter(getContext(), seriesTrending,
    // trendingListener);
    ...
    // .tvShowDao()
    // .getDrakor(10, 0);
    // List<TVShow> limitedTrending = drakor.size() > 10 ? drakor.subList(0, 10) :
    // drakor;
    ...
    // @Override
    // public void run() {
    // ScaleCenterItemLayoutManager linearLayoutManager2 = new
    // ScaleCenterItemLayoutManager(
    ...
    // drakorAdapter = new MediaAdapter(getContext(), (List<MyMedia>) (List<?>)
    // limitedTrending,
    // fragmentManager);
    ...
    // }
    // transaction.add(R.id.container, showAllFragment); // Pass data to new
    // fragment
    ...
    // .tvShowDao()
    // .getNewShows(10, 0);
    // List<TVShow> limitedTrending = newSeason.size() > 10 ? newSeason.subList(0,
    // 10) : newSeason;
    ...
    // @Override
    // public void run() {
    // ScaleCenterItemLayoutManager linearLayoutManager3 = new
    // ScaleCenterItemLayoutManager(
    // getContext(), LinearLayoutManager.HORIZONTAL, false);
    //
    ...
    // List<MyMedia> limitedTrending = recommended.size() > 10 ?
    // recommended.subList(0, 10) : recommended;
    ...
    // recommendedAdapter = new MediaAdapter(getContext(), limitedTrending,
    // fragmentManager);
    ...
    // com.theflexproject.thunder.ui.detail.DetailFragment tvShowDetailsFragment =
